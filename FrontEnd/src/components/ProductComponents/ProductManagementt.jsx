...
//C:\Users\radia\Desktop\AdminPanel\Khareed-Ghar1.7.4\Khareed-Ghar\FrontEnd\src\components\ProductComponents\ProductComponents.jsx

import React, { useState } from 'react';
import data from '../../mockJsons/productData.json';
import {AddCategory} from "./ProductComponents"
import { Link } from 'react-router-dom';

export const  ProductManagementt =()=> {
  const [searchTerm, setSearchTerm] = useState('');
  const [currentPage, setCurrentPage] = useState(0);
